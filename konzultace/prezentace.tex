...
{
{
\usebackgroundtemplate{\vspace{100px}\includegraphics[height=0.8\paperheight]{prezentace1.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\includegraphics[height=0.8\paperheight]{prezentace2.png}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\includegraphics[height=0.8\paperheight]{prezentace3.png}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
{
{
\usebackgroundtemplate{\centerline{\includegraphics[height=\paperheight*0.8]{prezentace1.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\centerline{\includegraphics[height=\paperheight*0.8]{prezentace2.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\centerline{\includegraphics[height=\paperheight*0.8]{prezentace3.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

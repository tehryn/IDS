...
{
{
\usebackgroundtemplate{\includegraphics[height=0.9\paperheight]{prezentace1.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\includegraphics[height=0.9\paperheight]{prezentace2.png}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\includegraphics[height=0.9\paperheight]{prezentace3.png}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

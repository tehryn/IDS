...
{
{
\usebackgroundtemplate{\centerline{\vspace{0.1\paperheight}\includegraphics[height=0.8\paperheight]{prezentace1.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\centerline{\vspace{0.1\paperheight}\includegraphics[height=0.8\paperheight]{prezentace2.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
{
\usebackgroundtemplate{\centerline{\vspace{0.1\paperheight}\includegraphics[height=0.8\paperheight]{prezentace3.png}}}
\begin{frame}[plain]
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

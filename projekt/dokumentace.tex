...
\begin{document}
    ...
    \section{Procedury}
    Obě ze dvou procedur používají CURSOR a EXCEPTION. Procedura  \texit{procento_vytvorenych_rezervaci}
    ...
    Druhá procedura \textit{pocet_zidli} má jako parametr lokaci a vypíše
    ...
    celou tabulkou pez použití indexu, INDEX_FULL_SCAN značí zase použití INDEXU.
